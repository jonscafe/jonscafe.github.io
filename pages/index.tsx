      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="pt-8 pb-8 space-y-2 md:space-y-5">
          <p className="text-lg leading-7 text-center text-gray-500 dark:text-gray-400">
            ...
            >
              {`We play every weekend to sharpen our knowledge and have fun at the same time! Currently, we are ranked 23rd in the world on CTFTime, hold the 2nd position in the Indonesian region, and aim to be among the top 10 teams worldwide in CTF (CTFTime)!`}
            </code>
          </p>
        </div>
        <ul className="">
